...
router.get('/', authorizeRoles('superadmin', 'admin', 'user', 'viewer'), getZones);
router.post('/', authorizeRoles('superadmin', 'admin', 'user'), createZone);
router.put('/:id', authorizeRoles('superadmin', 'admin', 'user'), updateZone);
