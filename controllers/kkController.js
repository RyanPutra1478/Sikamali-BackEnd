...
exports.getKKPreview = async (req, res) => {
    try {
        const { role, id } = req.user;
        const userIdFilter = (role === 'superadmin' || role === 'admin' || role === 'user' || role === 'viewer') ? null : id;
        ...
        sql += ' ORDER BY k.provinsi ASC, k.kabupaten ASC, k.kecamatan ASC, k.desa ASC, k.alamat ASC, k.kepala_keluarga ASC';
    ...
    try {
        ...
        let sql = `
            SELECT 
                ...
                m.pekerjaan,
                m.hubungan_keluarga,
                m.status_domisili as status_kependudukan,
        ...
        sql += ' ORDER BY k.provinsi ASC, k.kabupaten ASC, k.kecamatan ASC, k.desa ASC, k.alamat ASC, k.kepala_keluarga ASC, m.id ASC';
